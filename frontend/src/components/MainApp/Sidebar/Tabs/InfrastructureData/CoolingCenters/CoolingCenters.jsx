...
function CoolingCenters() {
    // Local state for managing checkbox status
    const [checkedItems, setCheckedItems] = useState({ coolingCenters: false });
    ...
    const coolingCentersMenu = [
        {
            name: 'Cool Centers and Hydration Stations',
            id: 'coolingCenters',
            component: 'Cooling Centers Info', // Replace with actual component or data
        },
    ];
